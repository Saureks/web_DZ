...
<main>
    ...
    <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-12">
                        <form>
                            ...
                            <button type="send" class="btn btn-success">Отправить</button>
                        </form>
                    </div>
                </div>
            </main>
        ...
        <header>
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal text-body-emphasis">раздел FAQ</h1>
            </div>
        </header>
        <div class="row">
            <div class="col-4">
                ...
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <div class="card card-body">
                            Подберите интересующие вас товары через поиск или каталог. Добавьте товары в корзину.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-4">
                ...
                <div class="collapse multi-collapse" id="multiCollapseExample2">
                    <div class="card card-body">
                        Минимальная сумма для оформления заказа – 500 рублей, доставка может быть бесплатной при чеке от 1 500 рублей
                    </div>
                </div>
            </div>
            <div class="col-4">
                ...
                <div class="collapse multi-collapse" id="multiCollapseExample3">
                    <div class="card card-body">
                        Выявлен недостаток в течение 14 дней со дня покупки – вернем или обменяем товар без диагностики.
                    </div>
                </div>
            </div>
        </div>
